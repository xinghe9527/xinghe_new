...
- **Stack**: React, Vue, Next.js, Flutter, or default to `html-tailwind`
...
## Example Workflow for Flutter Canvas App

**User request:** "优化 AI 画布的 UI 设计"

### Step 1: Analyze Requirements
- Product type: Creative tool, Canvas workspace
- Style keywords: clean, modern, professional, infinite canvas
...
```bash
python3 .shared/ui-ux-pro-max/scripts/search.py "creative canvas design tool workspace" --design-system -p "AI Canvas"
```

### Step 3: Get Flutter-specific Guidelines

```bash
python3 .shared/ui-ux-pro-max/scripts/search.py "canvas drag gesture layout" --stack flutter
```

### Step 4: Check UX Best Practices

```bash
python3 .shared/ui-ux-pro-max/scripts/search.py "infinite canvas zoom pan interaction" --domain ux
```
...
Use the slash command to invoke this workflow:

```
/ui-ux-pro-max Build a landing page for my SaaS product
```

Or simply mention UI/UX work in your request, and I'll automatically use this workflow to provide professional design guidance.
